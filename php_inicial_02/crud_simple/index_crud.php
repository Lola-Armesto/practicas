...
<html>
	...
	<body>
		...
		<nav id = "menu" >
				...
				<button><a href="#read" id="btn2" onclick="ver()">Operaciones en Registros</a></button>
		
		</nav>
	
		<div id = "create" >
			<p><u><label style = "color:green;">Alta Usuarios<label></u></p>
		...
		<div id = "read" style="display:inline">
